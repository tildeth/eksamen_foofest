    ...
    <section className={styles.ticketSection}>
      ...
      <div className={styles.ticketType}>
        <label className={styles.ticketLabel}>
          ...
          <div className={styles.counter}>
            <button
              aria-label="plusknap standardbillet"
              type="button"
            ...
            <button
              aria-label="minus knap standardbillet"
              type="button"
              className={styles.counterButton}
      ...
      <div className={styles.ticketType}>
        <label className={styles.ticketLabel}>
          ...
          <div className={styles.counter}>
            <button
              aria-label="minus knap vipbillet"
              type="button"
              className={styles.counterButton}
              onClick={decreaseVip}
            >
            ...
            <button
              aria-label="plus knap vipbillet"
              type="button"
              className={styles.counterButton}
              onClick={increaseVip}
            >
...
export async function getServerSideProps() {
  return {
    props: {
      title: "Billet",
      description: "Vælg dine billetter her!",
    },
  };
}
